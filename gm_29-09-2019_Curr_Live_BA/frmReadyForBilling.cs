...
namespace gm
{
    public partial class frmReadyForBilling : Form
    {
        ...
        public frmReadyForBilling()
        {
            InitializeComponent();
        }

        private void frmReadyForBilling_Load(object sender, EventArgs e)
        {
...
//                     OrderItem.Remark,BatchAllocation.WareHouseCode, BatchAllocation.ProductCode  ,OrderItem.ProductName,BatchAllocation.BatchNo,BatchAllocation.QTY,
...
//                      and BatchAllocation.ProductCode=OrderItem.ProductCode and CONVERT(varchar, BatchAllocation.IOMNO)+BatchAllocation.ProductCode  
...
//                      Union all  
//                    select CONVERT(varchar,iomno)+MaterialCode from IBISBillingUpdate  where OrdUpdated =1  Union all   select CONVERT(varchar,iomno)+MaterialCode 
