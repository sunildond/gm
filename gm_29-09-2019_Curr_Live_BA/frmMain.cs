...
namespace GlanMark
{
    public partial class frmSQLServerBackup : Form
    {
        Server srv;
        ServerConnection conn;

        public frmSQLServerBackup()
        {
            InitializeComponent();
        }
        ...
        private void btnBackupDB_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                fileName += "gm" + DateTime.Now.Year.ToString() + DateTime.Now.Month.ToString() + DateTime.Now.Day.ToString() + DateTime.Now.Hour.ToString() + DateTime.Now.Minute.ToString() + DateTime.Now.Second.ToString() + ".bak";
