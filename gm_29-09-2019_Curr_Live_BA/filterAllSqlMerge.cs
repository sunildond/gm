...
namespace GlanMark
{
    public partial class filterAllSqlMerge : Form
    {
        ...
        public filterAllSqlMerge()
        {
            InitializeComponent();

            CommonFunction objCommon = new CommonFunction();
            CommDT = objCommon.GetDataTable(ConfigurationSettings.AppSettings["AllSqlMergeQuery"].ToString());
            bindIOMNo();
            BindPartyCode();
            BindSTNNo();
            BindLocationCode();            
        ...
        protected void execQuery(string strQuery)
        {
            try
            {
                //Comment by 20-08-2014
                //objC = new CommonFunction();
                //sqlDataAdapter = objC.GetSqlDataAdapter(strQuery.ToString());  //objC.GetSqlDataAdapter(ConfigurationSettings.AppSettings["AllSqlMergeQuery"].ToString());
                //txtQuery.Text = strQuery.ToString();    //ConfigurationSettings.AppSettings["AllSqlMergeQuery"].ToString();
                ...
                lblReportName.Text = "AllSqlMergeQuery";
                DataTable dtQuery = objC.GetDataTable(strQuery.ToString());
                bindingSource = new BindingSource();
                bindingSource.DataSource = dtQuery;
                dgvQueryExec.DataSource = bindingSource;
                lblCount.Text = "Total No. of Record: " + dgvQueryExec.Rows.Count;
            ...
            {
                MessageBox.Show("All Query Merge not get Executed!");
            }
        }
        ...
        private void bindIOMNo()
        {
            try
            {
                ...
                //CommonFunction objCommon = new CommonFunction();
                //dt = objCommon.GetDataTable(ConfigurationSettings.AppSettings["AllSqlMergeQuery"].ToString());
        ...
        private void btnFilter_Click(object sender, EventArgs e)
        {
            try
            {
                string Query = "select * from ( " + ConfigurationSettings.AppSettings["AllSqlMergeQuery"].ToString() + " ) as a ";
        ...
        {
            execQuery(ConfigurationSettings.AppSettings["AllSqlMergeQuery"].ToString());
        }
        ...
        private void btnExportToExcel_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("All SQL Query not get Executed!");
            }
        }
        ...
        private void filterAllSqlMerge_Load(object sender, EventArgs e)
        {
